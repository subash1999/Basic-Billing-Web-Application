    ...
    class Validation {
        ...
        public function pattern($name){
            ...
            if($name == 'array'){
                ...
                if(!is_array($this->value)){
                    $this->errors[] = $this->name.': Format of input is not Valid.';
                }
        ...
        public function required(){
            ...
            if((isset($this->file) && $this->file['error'] == 4) || ($this->value == '' || $this->value == null)){
                $this->errors[] = $this->name.': Field is Required';
            }            
            return $this;
        ...
        public function min($length){
            ...
            if(is_string($this->value)){
                ...
                if(strlen($this->value) < $length){
                    $this->errors[] = $this->name.": Entered value\'s length is less than minimum length {$length}.";
                }
           
            }else{
                
                if($this->value < $length){
                    $this->errors[] = $this->name." Entered Value is less than minimum value {$length}";
                }
        ...
        public function max($length){
            ...
            if(is_string($this->value)){
                ...
                if(strlen($this->value) > $length){
                    $this->errors[] = $this->name.": Entered value\'s length is greater than maximum length {$length}.";
                }
           
            }else{
                
                if($this->value > $length){
                    $this->errors[] = " Entered Value is greater than maximum value {$length}.";
                }
        ...
        public function equal($value){
            ...
            if($this->value != $value){
                $this->errors[] = $this->name.' Value doesnot match required Value';
            }
            return $this;
        ...
        public function maxSize($size){
            ...
            if($this->file['error'] != 4 && $this->file['size'] > $size){
                $this->errors[] = $this->name.': File size is more than '.number_format($size / 1048576, 2).' MB.';
            }
            return $this;
        ...
        public function ext($extension){
            ...
            if($this->file['error'] != 4 && pathinfo($this->file['name'], PATHINFO_EXTENSION) != $extension && strtoupper(pathinfo($this->file['name'], PATHINFO_EXTENSION)) != $extension){
                $this->errors[] = $this->name.' Only the file with extension '.$extension.' is accepted.';
            }
            return $this;
