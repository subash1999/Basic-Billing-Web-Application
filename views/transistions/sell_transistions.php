...
if(isset($_POST)){
    if(isset($_POST["delete_transistion_id"])){
        ...
        unset($_POST);
        header("Location: ".view_url("transistions/sell_transistions.php?id=$new_bill_id"));
        exit;
    }
...
$transistions = $transistion->get_sell_transistions();
if(isset($_GET['date'])){
    $date = $_GET['date'];
    if($date == NULL || empty($date) ){
        header("Location: ".view_url("transistions/sell_transistions.php"));
        exit;
    }
    else{
        $transistions = $transistion->get_sell_transistions_of_date($date);
    }
}
?>
...
<div class="container">
    ...
    <script>
        $("#filter_by_date_btn").click(function(){
            ...
            var new_location = "<?php echo(view_url("transistions/sell_transistions.php")); ?>?date="+date_val;
